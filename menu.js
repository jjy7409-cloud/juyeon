document.addEventListener('DOMContentLoaded', () => {
    ...
    const defaultItems = [
        ...
        },
        {
            id: 'or-yuzu',
            name: '유자오란다',
            desc: '상큼하고 향긋한 국내산 유자청과 유자 필을 더해 깔끔하게 맛을 낸 수제 오란다',
            cat: 'oranda',
            show: true,
            price: '2,000'
        },
        {
            id: 'or-gamtae',
            name: '감태오란다',
            desc: '바다 향 가득한 청정 감태를 올려 짭조름하고 은은한 단짠의 조화를 이룬 수제 오란다',
            cat: 'oranda',
            show: true,
            price: '2,000'
        },
        ...
        },
        {
            id: 'or-konggopul',
            name: '콩고물오란다',
            desc: '국내산 콩고물을 가득 묻혀 구수하고 달달한 인절미 맛을 낸 수제 오란다',
            cat: 'oranda',
            show: true,
            price: '2,000'
        },
